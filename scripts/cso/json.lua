...
-- //tb/1704
-- a few adaptions to run as library for CSO (http://github.com/7890/ardour_cso)
-- usage in a nutshell:
-- x=json.encode({ 1, 2, 'fred', {first='mars',second='venus',third='earth'} })
-- y=json.decode(x)
-- print(x, y[4]['first'])
-- [1,2,"fred",{"second":"venus","third":"earth","first":"mars"}] mars

-----------------------------------------------------------------------------
-- Imports and dependencies
-----------------------------------------------------------------------------
--uncommented for CSO ('require' is nil'ed)
...
-- Module declaration
-----------------------------------------------------------------------------
--uncomment for CSO (make globally accessible)
--local 
